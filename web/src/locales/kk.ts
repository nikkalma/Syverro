...
export const kk: LocaleData = {
  ...
  admin: {
    ...
    studioCleanup: {
      ...
      searchOrCreatePlace: 'Орынды іздеу немесе жасау…', searchOrCreateSource: 'Дереккөзді іздеу немесе жасау…', searchOrCreateTaxonomy: 'Таксономиядан іздеу…', exists: 'Бар', createEntityQuestion: 'Жаңа таксономия нысанын жасау керек пе?', nameLabel: 'Атауы', typeLabel: 'Түрі', globalEntityNotice: 'Бұл нысан бүкіл жүйеде қолжетімді болады.', create: 'Жасау',
    },
    access: {
    ...
    authors: {
      ...
      editor: {
        ...
        discovery: {
          title: 'Дереккөз іздеу',
          description: 'Автор үшін шектелген және қауіпсіз дереккөз іздеу. Кандидаттар детерминирленген түрде бағаланады; тек жоғары сенімді дереккөздер автоматты түрде мақұлданады, қалғаны сіздің тексеруіңізді күтеді.',
          notConfigured: 'Дереккөз іздеу конфигурацияланбаған',
          notConfiguredHint: 'Бэкенд ортасында SYVAI_DISCOVERY_ENABLED=true орнатыңыз, шектелген дереккөз іздеуді қосу үшін.',
          statusLabel: 'Status',
    ...
    moderation: {
      ...
      aiReview: {
        ...
        historyEmpty: 'Әзірге қаралған ұсыныстар жоқ',
        requiresReview: 'Қарауды қажет етеді',
        underReview: 'Қаралуда',
        entity: 'Нысан',
        field: 'Өріс',
        run: 'Іске қосу',
        reviewedAt: 'Қаралды',
        quality: 'Сапаны тексеру',
        policy: 'Саясатты тексеру',
        allBands: 'Барлық санаттар',
        allEntities: 'Барлық нысандар',
        ...
        noEvidence: 'Дереккөздер тіркелмеген',
        openDetail: 'Ашу',
        reviewResultSucceeded: 'сәтті',
        reviewResultFailed: 'сәтсіз',
        bulkFailed: 'Кейбір әрекеттер орындалмады',
        historyBand: 'Санат',
      },
    },
    metadata: {
