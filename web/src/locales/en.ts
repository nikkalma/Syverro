...
export const en: LocaleData = {
  ...
  bookPage: {
    ...
    aboutTitle: 'About the book', noDescription: 'No description has been added yet.', descriptionTitle: 'Short summary',
    ...
    readerFitTitle: 'Who this book may suit', readerFitEmpty: 'Reader-fit analysis has not been published yet.',
    chronologyTitle: 'Chronology', chronologyEmpty: 'A verified chronology has not been published yet.',
  ...
  author: {
    ...
    citizenshipsEmpty: 'No citizenship data yet',
    connectionsEmpty: 'No connections yet',
    recommendationsEmpty: 'Recommendations coming later',
    ...
    metaOrigin: 'Origin',
    metaEthnicOrigin: 'Ethnic origin',
    metaCulturalIdentity: 'Cultural identity',
    metaMovements: 'Literary movements',
  ...
  admin: {
    editorial: {
      ...
      subtitle: 'Structured editorial progress: what is filled in, what needs attention, and what is still missing to complete the record.',
    ...
    studioCleanup: {
      ...
      aiTitle: 'AI suggestions', aiDescription: 'AI-generated enrichment suggestions. Every change requires curator approval.', proposed: 'Proposed', accepted: 'Accepted', rejected: 'Rejected', loadingSuggestions: 'Loading suggestions…', noFilteredSuggestions: 'No suggestions with this status.', noSuggestions: 'No AI suggestions yet.', confidence: 'confidence', currentValue: 'Current value', suggestedValue: 'Suggested value', empty: 'Empty', reject: 'Reject', accept: 'Accept', failedUpdate: 'Failed to update proposal', runResearch: 'Run research', runningResearch: 'Running…', runs: 'Runs', noRuns: 'No research runs yet', sources: 'Evidence', apply: 'Apply to timeline', applied: 'Applied', validationValidated: 'Validated', validationNeedsReview: 'Needs review', validationConflict: 'Conflict', validationInvalid: 'Invalid', conflictDuplicate: 'Duplicate', conflictNearDuplicate: 'Near duplicate', conflictConflict: 'Conflict', conflictNew: 'New',
      bootstrapAuthor: {
    ...
    authors: {
      ...
      editor: {
        ...
        identity: {
          nationalityStates: 'Nationality & States',
          nationality: 'Nationality',
          nationalityDesc: "Author's citizenship or national affiliation",
        ...
        graph: {
          ...
          workspaceDesc: 'Themes, motifs, concepts, and relations linked to this author will be managed here.',
        ...
        discovery: {
          ...
          description: 'Bounded, safe source discovery for this author. Candidates are assessed deterministically; only high-authority sources are auto-approved, everything else waits for your review.',
          notConfigured: 'Discovery is not configured',
          notConfiguredHint: 'Set SYVAI_DISCOVERY_ENABLED=true in the backend environment to enable bounded source discovery.',
          statusLabel: 'Status',
    ...
    moderation: {
      ...
      aiReview: {
        ...
        historyEmpty: 'No reviewed proposals yet',
        ...
        suggested: 'Suggested',
        evidence: 'Evidence',
        noEvidence: 'No sources attached',
        openDetail: 'Open',
        reviewResultSucceeded: 'succeeded',
        reviewResultFailed: 'failed',
        bulkFailed: 'Some actions failed',
        historyBand: 'Band',
      },
    },
    metadata: {
