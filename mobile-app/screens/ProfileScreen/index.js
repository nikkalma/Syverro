      ...
      <View style={{ alignItems: 'center', marginBottom: 24 }}>
        ...
        {isEditingName ? (
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            ...
            />
            <TouchableOpacity onPress={saveName} activeOpacity={0.7}><Text style={{ color: theme.primary, fontSize: 20 }}>✅</Text></TouchableOpacity>
            <TouchableOpacity onPress={() => setIsEditingName(false)} activeOpacity={0.7}><Text style={{ color: '#ff4444', fontSize: 20 }}>❌</Text></TouchableOpacity>
          </View>
        ) : (
