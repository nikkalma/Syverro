...
export const sr: LocaleData = {
  ...
  bookPage: {
    ...
    aboutTitle: 'O knjizi', noDescription: 'Opis još nije dodat.', descriptionTitle: 'Kratak sadržaj',
    ...
    readerFitTitle: 'Kome bi ova knjiga mogla odgovarati', readerFitEmpty: 'Analiza čitalačkog iskustva još nije objavljena.',
    chronologyTitle: 'Hronologija', chronologyEmpty: 'Proverena hronologija još nije objavljena.',
  ...
  author: {
    ...
    quotes: 'Citati',
    citizenships: 'Državljanstvo',
    awards: 'Nagrade',
    sources: 'Izvori',
    timelineEmpty: 'Još nema događaja u hronologiji',
    quotesEmpty: 'Još nema citata',
    awardsEmpty: 'Još nema nagrada',
    citizenshipsEmpty: 'Još nema podataka o državljanstvu',
    connectionsEmpty: 'Još nema veza',
    recommendationsEmpty: 'Preporuke dolaze kasnije',
    metaEthnicOrigin: 'Etničko poreklo',
    metaCulturalIdentity: 'Kulturni identitet',
    metaMovements: 'Književni pokreti',
    metaLanguages: 'Jezici',
  },
  ...
  admin: {
    ...
    authors: {
      ...
      editor: {
        ...
        discovery: {
          title: 'Pronalaženje izvora',
          description: 'Ograničeno i bezbedno pronalaženje izvora za autora. Kandidati se procenjuju deterministički; samo visokopouzdani izvori se automatski odobravaju, ostali čekaju vaš pregled.',
          notConfigured: 'Pronalaženje izvora nije konfigurisano',
          notConfiguredHint: 'Postavite SYVAI_DISCOVERY_ENABLED=true u okruženju bekenda da omogućite ograničeno pronalaženje izvora.',
          statusLabel: 'Status',
    ...
    moderation: {
      ...
      aiReview: {
        ...
        historyEmpty: 'Još nema pregledanih predloga',
        requiresReview: 'Zahteva pregled',
        underReview: 'Na pregledu',
        entity: 'Entitet',
        field: 'Polje',
        run: 'Pokretanje',
        reviewedAt: 'Pregledano',
        quality: 'Provera kvaliteta',
        policy: 'Provera politike',
        allBands: 'Sve kategorije',
        ...
        evidence: 'Izvori',
        noEvidence: 'Nema priloženih izvora',
        openDetail: 'Otvori',
        reviewResultSucceeded: 'uspešno',
        reviewResultFailed: 'neuspešno',
        bulkFailed: 'Neke akcije nisu uspele',
        historyBand: 'Kategorija',
      },
    },
    metadata: {
      title: '📋 Book Metadata',
